...
Table 80021 "HR Employees"
{
    ...
    fields
    {
        field(1; "No."; Code[20])
        {
            ...
            begin
                ...
                if "No." = '' then begin
                    ...
                    else if "Contract Type" = "contract type"::"Full Time" then begin
                    ...
                    end else if "Contract Type" = "contract type"::Committee then begin
        ...
        field(2006; "Total (Leave Days)"; Decimal)
        {
            CalcFormula = sum("HR Leave Ledger Entries"."No. of days" where("Staff No." = field("No."),
                                                                             "Posting Date" = field("Date Filter"),
                                                                             "Leave Entry Type" = filter(Positive | Reimbursement),
                                                                             Closed = const(false),
                                                                             "Leave Type" = const('ANNUAL')));
            DecimalPlaces = 2 : 2;
            Editable = false;
        ...
        {
            CalcFormula = sum("HR Leave Ledger Entries"."No. of days" where("Leave Type" = const('EXAM'),
                                                                             "Staff No." = field("No.")));
            FieldClass = FlowField;
        }
        ...
        field(53960; "Supervisor User ID"; Code[100])
        {
            DataClassification = ToBeClassified;
        ...
        field(51516004; "Supervisor Name"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    var
        ...
        UserMgt: Codeunit "User ManagementII";
