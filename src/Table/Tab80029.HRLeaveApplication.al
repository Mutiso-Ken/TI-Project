...
Table 80029 "HR Leave Application"
{
    ...
    fields
    {
        ...
        field(4; "Days Applied"; Decimal)
        {
            ...
            begin
                ...
                if balance < "Days Applied" then
                    Error('you cannot apply for more that %1 days', balance);
        ...
        field(5; "Start Date"; Date)
        {
            ...
            begin
                ...
                HRLeaveApp.SetFilter(Status, '<>%1', HRLeaveApp.Status::Rejected);
        ...
        field(3970; "Approved days"; Decimal)
        {
    ...
    procedure CalcEndDate(SDate: Date; LDays: Decimal) LEndDate: Date
    var
        EndLeave: Boolean;
        DayCount: Decimal;
        ltype: Record "HR Leave Types";
