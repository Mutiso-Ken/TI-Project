...
Table 80001 "Payroll Transaction Code_AU"
{
    ...
    fields
    {
        field(10; "Transaction Code"; Code[10])
        {
            Editable = true;
        }
        ...
        field(55; "housing Leavy"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(56; StopCharge; Boolean)
        {
            DataClassification = ToBeClassified;
        }
