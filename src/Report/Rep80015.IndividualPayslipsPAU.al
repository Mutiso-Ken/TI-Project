...
Report 80015 "Individual Payslips P_AU"
{
    WordLayout = 'Layouts/IndividualPayslipsP_AU.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Payroll Employee_AU"; "Payroll Employee_AU")
        {
            ...
            begin
                ...
                Branchno := "Payroll Employee_AU"."Branch Name";
    ...
    begin
        if UserSetup.Get(UserId) then begin
            if UserSetup."Reversal Right" = false then Error('You dont have permissions for payroll, Contact your system administrator! ')
        end;
