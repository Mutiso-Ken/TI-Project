...
Report 80036 "Payment Memo"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Payment Memo.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(MissionProposalNo_PurchaseHeader; "Purchase Header"."Mission Proposal No")
            {
            }
            column(Ref; "Purchase Header"."Your Reference")
            {
            }
            column(Background; "Purchase Header".Background)
            {
            }
