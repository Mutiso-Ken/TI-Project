...
Report 80031 "Payslips W_AU"
{
    RDLCLayout = 'Layouts/PayslipsW_AU.rdlc';
    DefaultLayout = RDLC;
    ...
    begin
        if UserSetup.Get(UserId) then begin
            if UserSetup."View Payroll" = false then Error('You dont have permissions to run the report, Contact your system administrator! ')
        end;
