...
{
    WordLayout = 'Layouts/ImprestSurrender.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(AmountSpent_PurchaseLine; "Purchase Line"."Amount Spent")
                {
                }
                column(CashRefund_PurchaseLine; "Purchase Line"."Cash Refund")
                {
                }
