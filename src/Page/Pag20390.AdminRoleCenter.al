...
Page 50390 "Admin Role Center"
{
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group("Mission ProposalsII")
            {
                Caption = 'Mission Proposals';
                Image = Sales;
                ToolTip = 'Make quotes, orders, and credit memos to customers. Manage customers and view transaction history.';
                action("Mission Proposals")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'New Mission Proposals';
                    RunObject = Page "Mission Proposals";
                }
                action("Pending Mission Proposals")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Pending Mission Proposals';
                    RunObject = Page "Pending Mission Proposals";
                }
                action("Approved Mission Proposals")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Approved Mission Proposals';
                    RunObject = Page "Approved Mission Proposals";
                }
                action("Completed Mission Proposals")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Completed Mission Proposals';
                    RunObject = Page "Completed Mission Proposals";
            ...
            group("Payment MemosII")
            {
                ...
                Image = Sales;
                ToolTip = 'Make quotes, orders, and credit memos to customers. Manage customers and view transaction history.';
                action("Payment Memos")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'New Payment Memos';
                    RunObject = Page "Payment Memos";
                }
                action("Pending Payment Memos")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Pending Payment Memos';
                    RunObject = Page "Pending Payment Memos";
                }
                action("Approved Payment Memos")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Approved Payment Memos';
                    RunObject = Page "Approved Payment Memo";
                }
                action("Completed Payment Memos")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Completed Payment Memos';
            ...
            group(Payroll)
            {
                ...
                action("Payroll Inactive Employees")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Payroll Employees(Inactive)';
                    RunObject = Page "Payroll employee Inactive";
                }
                action("Payroll Periods")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Payroll Periods';
                    RunObject = Page "Payroll Calender_AU";
                }
