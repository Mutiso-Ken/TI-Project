Page 80084 "Budget Notes"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                field(Details; Rec."Description 3")
                {
                    ApplicationArea = Basic;
                    Caption = 'Details';
                }
                field("Vendor 1"; Rec."Description 2")
                {
                    ApplicationArea = Basic;
                    Caption = 'Vendor 1';
                    ShowMandatory = true;
                }
                field("Vendor 2"; Rec."Description 4")
                {
                    ApplicationArea = Basic;
                    Caption = 'Vendor 2';
                }
                field("Vendor 3"; Rec."Description 5")
                {
                    ApplicationArea = Basic;
                    Caption = 'Vendor 3';
                }
                field(Comments; Rec."Description 6")
                {
                    ApplicationArea = Basic;
                    Caption = 'Comments';
                }
    ...
    begin
        //VALIDATE("No.");
        //Type:=Type::Item;
        Rec."Line Type" := Rec."line type"::"Budget Notes";
    end;
