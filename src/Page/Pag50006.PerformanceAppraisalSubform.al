...
Page 50006 "Performance Appraisal Subform"
{
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(actualAchieved; Rec.actualAchieved)
                {
                    ApplicationArea = Basic;
                }
                field(percentageOfTarget; Rec.percentageOfTarget)
                {
                    ApplicationArea = Basic;
                }
                ...
                field(weightingRating; Rec.weightingRating)
                {
                    ApplicationArea = Basic;
                }
            }
