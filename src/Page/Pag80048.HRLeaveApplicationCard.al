...
Page 80048 "HR Leave Application Card"
{
    ...
    begin
        ...
        if HREmp3.Get(HREmp2."Supervisor ID") then begin
            Rec.Supervisor := HREmp3."No.";
    ...
    procedure DetermineLeaveReturnDateII(var fBeginDate: Date; var fDays: Decimal) fReturnDate: Date
    begin
    ...
    procedure DetermineIfIncludesNonWorkingII(var fLeaveCode: Code[10]): Boolean
    begin
    ...
    procedure DeterminethisLeaveEndDateII(var fDate: Date) fEndDate: Date
    begin
        /*ReturnDateLoop := TRUE;
        fEndDate := fDate;
    ...
    procedure CreateLeaveLedgerEntriesII()
    begin
