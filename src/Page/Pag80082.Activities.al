...
Page 80082 Activities
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                field(Date; Rec."Expected Receipt Date")
                {
                ...
                field(Duration; Rec."Unit of Measure")
                {
                    ApplicationArea = Basic;
                    Caption = 'Duration';
                }
                field(Output; Rec."Description 2")
                {
                    ApplicationArea = Basic;
                    Caption = 'Output';
                    ShowMandatory = true;
    ...
    begin
        //VALIDATE("No.");
        //Type:=Type::Item;
        Rec."Line Type" := Rec."line type"::Activity;
    end;
