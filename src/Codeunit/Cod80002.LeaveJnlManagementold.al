...
Codeunit 80002 LeaveJnlManagementold
{
    ...
    procedure TemplateSelectionFromBatch(var InsuranceJnlBatch: Record "HR Leave Journal Template")
    var
    ...
    begin
        OpenFromBatch := true;
        InsuranceJnlTempl.Get(InsuranceJnlBatch.Name);
