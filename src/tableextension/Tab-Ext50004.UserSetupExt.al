...
tableextension 50004 "UsersetupExt" extends "User Setup"
{
    fields
    {
        ...
        field(53936; "Run payslip"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(172019; "Reject Loan"; Boolean)
        {
        ...
        field(17221; "BulkSms User"; Boolean)
        {

        }
        field(17222; "Unblock Mobile"; Boolean)
        {
        }
        field(17223; "Payments Batch"; code[100])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Gen. Journal Batch".Name where("Journal Template Name" = const('PAYMENTS'));
        }
        field(17224; "ImprestAccount"; code[100])
        {
            DataClassification = ToBeClassified;
            // TableRelation = Customer."No." where("Account Type" = const("Travel Advance"));
        }
